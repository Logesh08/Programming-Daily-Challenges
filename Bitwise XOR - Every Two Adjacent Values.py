...
# The program must accept N integers as the input. The program must perform bitwise XOR operation between every two adjacent values and print the results. Then the program must repeat the above process on the previous result till the result becomes a single integer.
