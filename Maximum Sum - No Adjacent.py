...
# The program must accept an integer matrix of size 2*N as the input. The program must print the maximum sum such that no two chosen integers are adjacent vertically, diagonally or horizontally in the matrix.
